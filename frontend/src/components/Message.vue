                    ...
                    <el-table-column prop="messages">
                      <template slot-scope="scope">
                        <!--<div @click="viewDetail(scope.$index)" style="cursor: pointer;font-size: 24px;margin-bottom:20px;margin-top:10px" class="question">-->
                          ...
                          <!--{{scope.row.fromId}}-->
                        <!--</div>-->
                        <div v-show="false" style="font-family: Microsoft YaHei;font-size: 16px;margin-left: 30px;margin-bottom: 5px" class="content">
                          id：{{scope.row.id}}
                        </div>
                        <div style="font-family: Microsoft YaHei;font-size: 16px;margin-left: 30px;margin-bottom: 5px" class="content">
                          发信人：{{scope.row.fromId}}
                        </div>
                        <div style="font-family: Microsoft YaHei;font-size: 16px;margin-left: 30px;margin-bottom: 5px" class="content">
                          详细内容：{{scope.row.content}}
                        </div>
                        <div style="font-family: Microsoft YaHei;font-size: 16px;margin-left: 30px;margin-bottom: 5px" class="info1">
                          状态：
                        ...
                        <div style="font-family: Microsoft YaHei;font-size: 16px;margin-left: 30px;margin-bottom: 5px" class="info3">
